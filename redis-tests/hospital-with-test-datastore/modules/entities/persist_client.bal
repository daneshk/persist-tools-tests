    ...
    *persist:AbstractPersistClient;
    ...
    private final record {|predis:RedisMetadata...;|} & readonly metadata = {
        [APPOINTMENT]: {
            ...
            keyFields: ["id"],
            refMetadata: {
                patient: {entity: Patient, fieldName: "patient", refCollection: "Patient", refFields: ["idP"], joinFields: ["patientId"], 'type: predis:ONE_TO_MANY},
        ...
        [PATIENT]: {
            ...
            keyFields: ["idP"],
            refMetadata: {appointments: {entity: Appointment, fieldName: "appointments", refCollection: "Appointment", refFields: ["patientId"], joinFields: ["idP"], 'type: predis:MANY_TO_ONE}}
        },
        [DOCTOR]: {
            entityName: "Doctor",
